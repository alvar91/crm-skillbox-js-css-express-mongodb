...
const createProductItemTemplate = (client) => `<div class="table__row">
...
export default class SearchProfile extends AbstractView {
  constructor(client) {
    super();
    this._client = client;
  }
  ...
  getTemplate() {
    return createProductItemTemplate(this._client);
  }
